    ...
    'src/i18n.ts'() {
      LOCALES = {
        ...
        'pt-BR': {
          ...
          'history.hint':
            'Salvo automaticamente a cada 30\u202Fs e ao sair do editor. Clique em uma vers\xE3o para restaurar.',
          ...
          'stats.readTime': (m) => `~${m} min`,
          'lint.heading': (prev, cur) =>
            `Hierarquia de t\xEDtulos: H${prev} seguido de H${cur} \u2014 n\xEDvel intermedi\xE1rio ausente`,
          'lint.unclosedLink': 'Link n\xE3o fechado \u2014 falta o `)` de encerramento',
          'lint.imageAlt': 'Imagem sem texto alternativo (alt text)',
          'lint.multipleH1': (n) =>
            `${n} t\xEDtulos H1 encontrados \u2014 recomenda-se apenas um por documento`,
          ...
          'history.empty':
            'Sem hist\xF3rico salvo ainda. O editor salva automaticamente a cada 30\u202Fs.',
          ...
          'help.s1d2':
            'Arraste e solte um arquivo <strong>.md</strong> no editor para careg\xE1-lo.',
          'help.s1d3':
            'Arraste e solte uma <strong>imagem</strong> para inseri-la inline como Base64.',
          'help.s1d4':
            'A barra de estat\xEDsticas mostra contagem de palavras, tempo de leitura e alertas.',
          'help.s1d5':
          ...
          'help.s3d1':
            'Salva automaticamente a cada 30\u202Fs e ao sair do campo. Clique em uma vers\xE3o no <strong>Hist\xF3rico</strong> para restaur\xE1-la.',
          'help.s4': 'Gerador de Tabela',
          'help.s4d1':
            'Clique em <strong>Tabela</strong> para abrir o gerador. Defina linhas e colunas, preencha as c\xE9lulas e clique em Inserir.',
          'help.s5': 'Temas do Preview',
          'help.s5d1':
            'Clique em <strong>Temas</strong> para alternar: <em>GitHub</em>, <em>Moderno</em>, <em>Acad\xEAmico</em> ou <em>Minimalista</em>.',
          'help.s6': 'Ajustes',
          'help.s6d1':
        ...
        es: {
          ...
          'history.hint':
            'Guardado autom\xE1ticamente cada 30\u202Fs y al salir del editor. Haz clic en una versi\xF3n para restaurar.',
          ...
          'stats.readTime': (m) => `~${m} min`,
          'lint.heading': (prev, cur) =>
            `Jerarqu\xEDa de encabezados: H${prev} seguido de H${cur} \u2014 nivel intermedio faltante`,
          ...
          'issues.overflow': (n) =>
            `\u2026y ${n} m\xE1s ${n === 1 ? 'advertencia' : 'advertencias'}`,
          ...
          'history.empty':
            'Sin historial guardado a\xFAn. El editor guarda autom\xE1ticamente cada 30\u202Fs.',
          ...
          'help.s1d4':
            'La barra de estad\xEDsticas muestra recuento de palabras, tiempo de lectura y advertencias.',
          'help.s1d5':
            'Pega <strong>HTML</strong> directamente en el editor \u2014 se convierte autom\xE1ticamente a Markdown.',
          'help.s2': 'Exportar',
          'help.s2intro':
          ...
          'help.s3d1':
            'Se guarda autom\xE1ticamente cada 30\u202Fs y al perder el foco. Haz clic en una versi\xF3n en <strong>Historial</strong> para restaurarla.',
          ...
          'help.s5d1':
            'Haz clic en <strong>Temas</strong> para cambiar: <em>GitHub</em>, <em>Moderno</em>, <em>Acad\xE9mico</em> o <em>Minimalista</em>.',
          'help.s6': 'Ajustes',
          'help.s6d1':
        ...
        fr: {
          ...
          'settings.syncDesc':
            'Synchronise le d\xE9filement entre l\u2019\xE9diteur et l\u2019aper\xE7u',
          ...
          'history.hint':
            'Sauvegard\xE9 automatiquement toutes les 30\u202Fs et \xE0 la sortie de l\u2019\xE9diteur. Cliquez sur une version pour la restaurer.',
          ...
          'lint.heading': (prev, cur) =>
            `Hi\xE9rarchie des titres\xA0: H${prev} suivi de H${cur} \u2014 niveau interm\xE9diaire manquant`,
          'lint.unclosedLink':
            'Lien non ferm\xE9 \u2014 la parenth\xE8se `)` de fermeture est manquante',
          'lint.imageAlt': 'Image sans texte alternatif (alt text)',
          'lint.multipleH1': (n) =>
            `${n} titres H1 trouv\xE9s \u2014 un seul est recommand\xE9 par document`,
          ...
          'history.empty':
            'Aucun historique enregistr\xE9. L\u2019\xE9diteur sauvegarde automatiquement toutes les 30\u202Fs.',
          ...
          'help.s1d1':
            'R\xE9digez du Markdown dans le panneau gauche \u2014 l\u2019aper\xE7u se met \xE0 jour en temps r\xE9el.',
          'help.s1d2':
            'Glissez-d\xE9posez un fichier <strong>.md</strong> dans l\u2019\xE9diteur pour le charger.',
          'help.s1d3':
            'Glissez-d\xE9posez une <strong>image</strong> pour l\u2019ins\xE9rer en ligne en Base64.',
          'help.s1d4':
            'La barre de statistiques affiche le nombre de mots, le temps de lecture et les avertissements.',
          'help.s1d5':
            'Collez du <strong>HTML</strong> directement dans l\u2019\xE9diteur \u2014 il est automatiquement converti en Markdown.',
          'help.s2': 'Exporter',
          'help.s2intro':
            'Cliquez sur <strong>Exporter</strong> dans le dock pour copier dans l\u2019un de ces formats\xA0:',
          'help.s2d1':
          ...
          'help.s3d1':
            'Sauvegarde automatiquement toutes les 30\u202Fs et \xE0 la perte du focus. Cliquez sur une version dans <strong>Historique</strong> pour la restaurer.',
          'help.s4': 'G\xE9n\xE9rateur de tableaux',
          'help.s4d1':
            'Cliquez sur <strong>Tableau</strong> pour ouvrir le g\xE9n\xE9rateur. D\xE9finissez les lignes et colonnes, remplissez les cellules et cliquez sur Ins\xE9rer.',
          'help.s5': 'Th\xE8mes de l\u2019aper\xE7u',
          'help.s5d1':
            'Cliquez sur <strong>Th\xE8mes</strong> pour choisir\xA0: <em>GitHub</em>, <em>Moderne</em>, <em>Acad\xE9mique</em> ou <em>Minimaliste</em>.',
          'help.s6': 'Param\xE8tres',
          'help.s6d1':
            'Ouvrez les <strong>Param\xE8tres</strong> pour activer le d\xE9filement synchronis\xE9, le mode sombre, le verre d\xE9poli et changer la langue.',
        ...
        'pt-PT': {
          ...
          'history.clearBtn': 'Apagar tudo',
          'history.hint':
            'Guardado automaticamente a cada 30\u202Fs e ao sair do editor. Clique numa vers\xE3o para restaurar.',
          'table.title': 'Inserir Tabela',
          'table.rows': 'Linhas',
          'table.cols': 'Colunas',
          'table.hint': 'A primeira linha \xE9 o cabe\xE7alho \xB7 Tab para navegar',
          ...
          'stats.readTime': (m) => `~${m} min`,
          'lint.heading': (prev, cur) =>
            `Hierarquia de t\xEDtulos: H${prev} seguido de H${cur} \u2014 n\xEDvel intermedi\xE1rio em falta`,
          ...
          'history.empty':
            'Sem hist\xF3rico guardado ainda. O editor guarda automaticamente a cada 30\u202Fs.',
          'table.colPlaceholder': (c) => `Coluna ${c}`,
          'table.cellPlaceholder': (r, c) => `linha ${r}, col ${c}`,
          'slack.image': (alt) => `[Imagem: ${alt}]`,
          'slack.imagePlain': '[Imagem]',
          ...
          'help.s1d1':
            'Escreva Markdown no painel esquerdo \u2014 a pr\xE9-visualiza\xE7\xE3o atualiza em tempo real.',
          'help.s1d2':
          ...
          'help.s1d4':
            'A barra de estat\xEDsticas mostra contagem de palavras, tempo de leitura e avisos.',
          'help.s1d5':
            'Cole <strong>HTML</strong> diretamente no editor \u2014 convertido automaticamente para Markdown.',
          'help.s2': 'Exportar',
          'help.s2intro':
          ...
          'help.s3': 'Hist\xF3rico Local',
          'help.s3d1':
            'Guarda automaticamente a cada 30\u202Fs e ao sair do campo. Clique numa vers\xE3o no <strong>Hist\xF3rico</strong> para a restaurar.',
          'help.s4': 'Gerador de Tabela',
          'help.s4d1':
            'Clique em <strong>Tabela</strong> para abrir o gerador. Defina linhas e colunas, preencha as c\xE9lulas e clique em Inserir.',
          'help.s5': 'Temas da Pr\xE9-visualiza\xE7\xE3o',
          'help.s5d1':
            'Clique em <strong>Temas</strong> para alternar: <em>GitHub</em>, <em>Moderno</em>, <em>Acad\xE9mico</em> ou <em>Minimalista</em>.',
          'help.s6': 'Defini\xE7\xF5es',
          'help.s6d1':
            'Abra as <strong>Defini\xE7\xF5es</strong> para ativar scroll sincronizado, modo escuro, vidro fosco e mudar o idioma.',
          'help.s7': 'Refer\xEAncia R\xE1pida Markdown',
          'help.s8': 'Atalhos de Teclado',
        },
      };
...
`;
    ...
    function styleEl(el) {
      ...
      switch (tag) {
        ...
        case 'del':
          ...
          break;
        case 'a':
          el.setAttribute('style', `color:${p.accent};text-decoration:none;`);
          break;
        case 'img':
          el.setAttribute('style', 'max-width:100%;height:auto;');
          break;
        case 'hr':
          el.setAttribute('style', `border:none;border-top:1px solid ${p.border};margin:24px 0;`);
          break;
      }
  ...
  function formatHistoryDate(ts) {
    ...
    return d.toLocaleDateString(currentLang.startsWith('pt') ? currentLang : 'en', {
      day: '2-digit',
      month: '2-digit',
      hour: '2-digit',
      minute: '2-digit',
...
`;
  ...
  var require_main = __commonJS({
    'src/main.ts'() {
      ...
      function applyLanguage(lang) {
        ...
        if (langContainer) {
          langContainer
            ...
            .forEach((el) => el.classList.toggle('selected', el.dataset.lang === lang));
      ...
      var existingNames = new Set(CodeMirror.modeInfo.map((m) => m.name.toLowerCase()));
      ...
      document.addEventListener('click', (e) => {
        ...
        if (
          ...
          !target.closest('#btn-export, #btn-settings, #btn-themes, #btn-hamburger')
        ) {
          closeAllMenus();
        }
      });
      ...
      applyTheme(savedTheme !== null ? savedTheme === 'dark' : prefersDark.matches, false);
      ...
      btnCopyTeams.addEventListener('click', async () => {
        closeAllMenus();
        const html = buildInlineStyledHTML(preview.querySelector('.markdown-body'), 'teams');
      ...
      btnCopyEmail.addEventListener('click', async () => {
        closeAllMenus();
        const html = buildInlineStyledHTML(preview.querySelector('.markdown-body'), 'email');
        const plain = preview.querySelector('.markdown-body').innerText;
        try {
          await navigator.clipboard.write([
            new ClipboardItem({
...
`,
      ...
      cm.on('paste', (_, e) => {
        ...
        if (html) {
          const hasMarkup = /<(h[1-6]|p|ul|ol|li|table|blockquote|pre|strong|em|br)\b/i.test(html);
          if (hasMarkup) {
            e.preventDefault();
      ...
      document.addEventListener('keydown', (e) => {
        if (e.key === 'Escape' && historyModal.classList.contains('visible')) closeHistoryModal();
      });
      function buildTableGrid() {
        ...
        for (let r = 0; r < rows; r++) {
          for (let c = 0; c < cols; c++) {
            ...
            inp.placeholder =
              r === 0 ? t('table.colPlaceholder', c + 1) : t('table.cellPlaceholder', r, c + 1);
            ...
            inp.addEventListener('keydown', (e) => {
              if (e.key === 'Enter') {
                ...
                const next = tblGrid.querySelector(`[data-row='${nextR}'][data-col='${c}']`);
                if (next) next.focus();
              }
            });
      ...
      var portraitQuery = window.matchMedia('(max-width: 768px), (orientation: portrait)');
      ...
      paneHeaderEditor.addEventListener('click', () => togglePane(editorPaneEl, paneHeaderEditor));
      ...
      function buildHelpBody() {
        ...
        return [
          ...
          section(iconHistory, t('help.s3'), `<p class="help-p">${t('help.s3d1')}</p>`),
          section(iconTable, t('help.s4'), `<p class="help-p">${t('help.s4d1')}</p>`),
          section(iconThemes, t('help.s5'), `<p class="help-p">${t('help.s5d1')}</p>`),
          section(iconSettings, t('help.s6'), `<p class="help-p">${t('help.s6d1')}</p>`),
          section(
            iconMd,
            t('help.s7'),
          ...
          section(iconKbd, t('help.s8'), `<div class="help-shortcuts-grid">${kbdRows}</div>`),
        ].join('');
      }
      ...
      document.addEventListener('keydown', (e) => {
        if (e.key === 'Escape' && helpModal.classList.contains('visible')) closeHelpModal();
      });
    },
  });
  require_main();
