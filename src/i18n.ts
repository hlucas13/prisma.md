...
export const LOCALES = {
  en: {
    ...
    'export.teamsDesc': 'Inline HTML with Segoe UI styles \u00b7 code preserved',
    'export.emailDesc': 'Conservative inline CSS \u00b7 tables and bold guaranteed',
    ...
    'themes.minimalDesc': 'Neutral \u00b7 distraction-free \u00b7 light & dark',
    'stats.word': '1 word',
  ...
  'pt-BR': {
    ...
    'export.teamsDesc': 'HTML inline com estilos Segoe UI \u00b7 c\u00f3digo preservado',
    'export.emailDesc': 'CSS inline conservador \u00b7 tabelas e negritos garantidos',
    'export.slackDesc': 'Texto mrkdwn \u00b7 formato nativo do Slack',
    'export.whatsappDesc': 'Formato de texto \u00b7 negrito, it\u00e1lico, riscado',
    'export.telegramDesc': 'Formato HTML \u00b7 negrito, it\u00e1lico, c\u00f3digo, links',
    ...
    'table.rows': 'Linhas',
    'table.cols': 'Colunas',
    'table.hint': 'A primeira linha \u00e9 o cabe\u00e7alho \u00b7 Tab para navegar',
    'table.cancel': 'Cancelar',
    'table.insert': 'Inserir Tabela',
    'themes.label': 'Tema do preview',
    'themes.githubDesc': 'Cl\u00e1ssico \u00b7 azul/verde \u00b7 light & dark',
    'themes.modern': 'Moderno',
    'themes.modernDesc': '\u00cdndigo \u00b7 Helvetica \u00b7 light & dark',
    'themes.academic': 'Acad\u00eamico',
    'themes.academicDesc': 'Serifado Georgia \u00b7 s\u00e9pia \u00b7 light & dark',
    'themes.minimal': 'Minimalista',
    'themes.minimalDesc': 'Neutro \u00b7 sem distra\u00e7\u00e3o \u00b7 light & dark',
    ...
    'lint.unclosedLink': 'Link n\u00e3o fechado \u2014 falta o `)` de encerramento',
    ...
    'toast.fileUnsupported': 'Arquivo n\u00e3o suportado \u2014 use .md ou imagem',
    ...
    'help.s1d2': 'Arraste e solte um arquivo <strong>.md</strong> no editor para careg\u00e1-lo.',
  ...
  es: {
    ...
    'export.label': 'Copiar como\u2026',
    'export.universalDesc': 'HTML enriquecido \u00b7 Word, Notion y otras apps',
    'export.teamsDesc': 'HTML inline con estilos Segoe UI \u00b7 c\u00f3digo preservado',
    'export.emailDesc': 'CSS inline conservador \u00b7 tablas y negritas garantizadas',
    'export.slackDesc': 'Texto mrkdwn \u00b7 formato nativo de Slack',
    'export.whatsappDesc': 'Formato de texto \u00b7 negrita, it\u00e1lica, tachado',
    'export.telegramDesc': 'Formato HTML \u00b7 negrita, it\u00e1lica, c\u00f3digo, enlaces',
    'export.printName': 'Imprimir / PDF',
    ...
    'table.rows': 'Filas',
    'table.cols': 'Columnas',
    'table.hint': 'La primera fila es el encabezado \u00b7 Tab para navegar',
    'table.cancel': 'Cancelar',
    'table.insert': 'Insertar Tabla',
    'themes.label': 'Tema del preview',
    'themes.githubDesc': 'Cl\u00e1sico \u00b7 azul/verde \u00b7 claro & oscuro',
    'themes.modern': 'Moderno',
    'themes.modernDesc': '\u00cdndigo \u00b7 Helvetica \u00b7 claro & oscuro',
    'themes.academic': 'Acad\u00e9mico',
    'themes.academicDesc': 'Georgia serif \u00b7 sepia \u00b7 claro & oscuro',
    'themes.minimal': 'Minimalista',
    'themes.minimalDesc': 'Neutro \u00b7 sin distracciones \u00b7 claro & oscuro',
    ...
    'issues.overflow': (n) => `\u2026y ${n} m\u00e1s ${n === 1 ? 'advertencia' : 'advertencias'}`,
  ...
  fr: {
    ...
    'settings.glassDesc': 'Effet verre d\u00e9poli sur toute l\u2019interface',
    ...
    'export.universalDesc': 'HTML enrichi \u00b7 Word, Notion et autres apps',
    'export.teamsDesc': 'HTML inline avec styles Segoe UI \u00b7 code pr\u00e9serv\u00e9',
    'export.emailDesc': 'CSS inline conservateur \u00b7 tableaux et gras garantis',
    ...
    'export.printDesc': 'Aper\u00e7u natif \u00b7 utilise le th\u00e8me actif',
    ...
    'table.rows': 'Lignes',
    'table.cols': 'Colonnes',
    'table.hint': 'La premi\u00e8re ligne est l\u2019en-t\u00eate \u00b7 Tab pour naviguer',
    ...
    'themes.academicDesc': 'Georgia serif \u00b7 s\u00e9pia \u00b7 clair & sombre',
    'themes.minimal': 'Minimaliste',
    'themes.minimalDesc': 'Neutre \u00b7 sans distraction \u00b7 clair & sombre',
    'stats.word': '1 mot',
    ...
    'toast.copiedWhatsApp': 'Copi\u00e9 pour WhatsApp\u00a0! Collez avec Ctrl+V',
    'toast.copiedTelegram': 'Copi\u00e9 pour Telegram\u00a0! Collez avec Ctrl+V',
    'toast.fileLoaded': (name) => `\u00ab\u00a0${name}\u00a0\u00bb charg\u00e9`,
    'toast.imageInserted': (name) => `Image \u00ab\u00a0${name}\u00a0\u00bb ins\u00e9r\u00e9e`,
    'toast.fileUnsupported': 'Fichier non support\u00e9 \u2014 utilisez .md ou une image',
  ...
  'pt-PT': {
    ...
    'settings.syncName': 'Scroll sincronizado',
    'settings.syncDesc': 'Sincroniza o scroll entre o editor e a pr\u00e9-visualiza\u00e7\u00e3o',
    ...
    'lint.closeAria': 'Fechar painel de avisos',
    'export.label': 'Copiar como\u2026',
    'export.universalDesc': 'HTML rico \u00b7 Word, Notion e outras aplica\u00e7\u00f5es',
    'export.teamsDesc': 'HTML inline com estilos Segoe UI \u00b7 c\u00f3digo preservado',
    'export.emailDesc': 'CSS inline conservador \u00b7 tabelas e negritos garantidos',
    'export.slackDesc': 'Texto mrkdwn \u00b7 formato nativo do Slack',
    'export.whatsappDesc': 'Formato de texto \u00b7 negrito, it\u00e1lico, riscado',
    ...
    'export.printName': 'Imprimir / PDF',
    'export.printDesc': 'Pr\u00e9-visualiza\u00e7\u00e3o nativa \u00b7 usa o tema ativo',
    'history.title': 'Hist\u00f3rico Local',
    'history.clearBtn': 'Apagar tudo',
    'history.hint':
    ...
    'themes.modernDesc': '\u00cdndigo \u00b7 Helvetica \u00b7 light & dark',
    'themes.academic': 'Acad\u00e9mico',
    'themes.academicDesc': 'Georgia serif \u00b7 s\u00e9pia \u00b7 light & dark',
    'themes.minimal': 'Minimalista',
    'themes.minimalDesc': 'Neutro \u00b7 sem distra\u00e7\u00e3o \u00b7 light & dark',
    'stats.word': '1 palavra',
    ...
    'lint.unclosedLink': 'Liga\u00e7\u00e3o n\u00e3o fechada \u2014 falta o `)` de encerramento',
    'lint.imageAlt': 'Imagem sem texto alternativo (alt text)',
    'lint.multipleH1': (n) =>
      `${n} t\u00edtulos H1 encontrados \u2014 recomenda-se apenas um por documento`,
    'grammar.repeated': (word) => `Palavra repetida: \u201c${word}\u201d`,
    ...
    'toast.fileLoaded': (name) => `\u201c${name}\u201d carregado`,
    'toast.imageInserted': (name) => `Imagem \u201c${name}\u201d inserida`,
    'toast.fileUnsupported': 'Ficheiro n\u00e3o suportado \u2014 utilize .md ou imagem',
    'toast.tablePasted': 'Tabela colada!',
    'toast.htmlConverted': 'HTML convertido para Markdown!',
    'toast.tableInserted': 'Tabela inserida!',
    'toast.versionRestored': 'Vers\u00e3o restaurada!',
